...
function Mesaages({message,own,image}) {
  return (
    <div className={own?'flex flex-col':'flex flex-col items-end mr-4'}>
          ...
          <img className='w-7 h-7 rounded-full mt-2 mb-2 mr-3 ml-3 border border-navbar' src={image} alt='image'/>
          ...
          <h3 className={own?'text-slate-400  ml-11':'text-slate-400  mr-32'}>3 mins ago</h3>
    </div>
  )
}
