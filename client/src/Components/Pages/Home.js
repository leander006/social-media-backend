  ...
  return (
    ...
    <Navbar/>
      <div className='flex justify-between bg-[#2D3B58]'>
        ...
        <ExploreMore loading={false}  name={"leander"} profile={"/images/noProfile.jpeg"} content={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSixnspHe2fobVRIxfj7VFzeLlMSfjxZwGtNQ&usqp=CAU"} liked={"10"} message={"this are messages"} caption={"This is caption"} count={"6"} likecount={"3"} likename={"aadil"} />
        </div>
